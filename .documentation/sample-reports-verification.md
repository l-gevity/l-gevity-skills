...
Next action:          Add the component at identity / primitive / infrastructure and forbid cross-domain imports.
Verification:         Add or update architecture lint for the forbidden edges.
```
